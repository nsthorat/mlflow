...
class TestTableCellFormatting:
    ...
    def test_format_table_cell_value_invalid_timestamp(self):
    ...
    def test_format_table_cell_value_invalid_duration(self):
